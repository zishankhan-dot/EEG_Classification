...
st.text("PhysioNet Dataset to predict Left/Right Motor Imagery on [C1,C2,Cz] channels")
...
# Main area
if uploaded is None:
    st.warning("Upload a PhysioNet EEG file (.edf) from the sidebar to get started.Runs Supported - [4, 8, or 12] (left/right hand imagery only).")
    st.stop()
